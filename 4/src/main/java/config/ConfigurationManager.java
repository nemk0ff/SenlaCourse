...
public class ConfigurationManager {
        ...
        for (Field field : clazz.getDeclaredFields()) {
            if (field.isAnnotationPresent(ConfigProperty.class)) {
                ...
                try {
                    ...
                    System.err.println("Error configuring field: " + field.getName() + " : " + e.getMessage());
                }
            }
        }
    }
    ...
    private static Properties loadProperties(String configFileName) throws IOException {
        ...
        try (InputStream input = ConfigurationManager.class.getClassLoader().getResourceAsStream(configFileName)) {
            if (input == null) {
